//============================================================================
// Author      : Omar_Hafez
// Created     : 12 July 2022 (Tuesday)  1:56:49 PM
//============================================================================
...
int main() { 
    ...
    sor(a);
    int mn = a[n-1].first-a[0].first;
    vpi ans;
    for(int i = 0; i < k && a[0].first < a[n-1].first; i++) {
    	ans.push_back({a[n-1].second, a[0].second});
    	a[n-1].first--;
    	a[0].first++;
    	sor(a);
    }
    mn = min(mn, a[n-1].first - a[0].first);
