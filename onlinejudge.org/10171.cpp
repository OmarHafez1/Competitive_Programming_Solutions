//============================================================================
// Author      : Omar_Hafez
// Created     : 13 July 2023 (Thursday)  4:23:45 PM
//============================================================================
...
signed main() { 
    ...
    while(1) {
        ...
        vector<char> ans;
        for(int i = 0; i < N; i++) {
            if(dp[0][u][i]+dp[1][v][i] < mn) {
                mn = dp[0][u][i]+dp[1][v][i];
                ans.clear();
                ans.push_back('A'+i);
            } else if(dp[0][u][i]+dp[1][v][i] == mn) ans.push_back(i+'A');
        }
        if(mn == INF) {
