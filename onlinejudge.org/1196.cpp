//============================================================================
// Author      : Omar_Hafez
// Created     : 13 May 2023 (Saturday)  5:08:53 PM
//============================================================================
...
int find(vector<pair<int, int>> &dp, int k, pair<int, int> p) {
    int l = 0, r = k, mid;
    while(l < r) {
        mid = (l+r)/2;
        if(dp[mid].first <= p.first && dp[mid].second <= p.second) {
            l = mid+1;
        } else {
            r = mid;
        }
