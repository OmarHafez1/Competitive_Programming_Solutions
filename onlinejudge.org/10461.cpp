...
**
**   author:  Omar_Hafez
**   created: 22 February 2022 (Tuesday)  10:09:36 AM
**
*/
...
void calc(int i, vec<vi> &adj, vi &a) {
  vb visited(n+1);
  queue<int> q;
  q.push(i);
  a[i] -= tms[i];
...
int main() { 
  ...
  while(1) {
    ...
    while(q--) {
      cin >> t1;
      cout << tot-bef[t1]-aft[t1]-tms[t1] << endl;
    }
    newl;
  }
