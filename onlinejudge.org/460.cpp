...
**
**   author:  Omar_Hafez
**   created: 04/01/2022  01:02:29 AM
**
*/
...
void calculate() {
  ...
  if(lx1 >= ux2 || lx2 >= ux1 || ly1 >= uy2 || ly2 >= uy1 || lx1 == ux1 || ly1 == uy1 || lx2 == ux2 || ly2 == uy2) {
    cout << "No Overlap\n";
    return;
  }
  lx1 = max(lx1, lx2); ly1 = max(ly1, ly2); ux1 = min(ux1, ux2); uy1 = min(uy1, uy2); 

  cout << lx1 << " " << ly1 << " " << ux1 << " " << uy1 << endl;
}
