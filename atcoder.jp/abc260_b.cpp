//============================================================================
// Author      : Omar_Hafez
// Created     : 17 July 2022 (Sunday)  2:20:15 PM
//============================================================================
...
signed main() { 
    ...
    vpi f;
    for(int i = 0; i < n; i++) {
    	f.push_back({a[i], 1000000-i});
    }
    rsor(f);
    vi ans;
    vb done(n);
    for(int i = 0; i < x; i++) {
    	done[1000000-f[i].second] = 1;
    	ans.push_back(1000000-f[i].second+1);
    }
    f.clear();
    for(int i = 0; i < n; i++) {
    	if(done[i]) {
