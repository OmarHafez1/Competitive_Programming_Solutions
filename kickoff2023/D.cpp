//============================================================================
// Author      : Omar_Hafez
// Created     : 06 May 2023 (Saturday)  7:52:16 PM
//============================================================================
...
signed main() { 
    ...
    while(q--) {
        cin >> ch;
        if(ch == 'R') {
            if(my.count(y) && my[y].upper_bound(x) != my[y].end()) {
                x = *my[y].upper_bound(x);
            }   
            cout << x << " " << y << endl;
        }
        if(ch == 'U') {
            if(mx.count(x) && mx[x].upper_bound(y) != mx[x].end()) {
                y = *mx[x].upper_bound(y);
            }   
            cout << x << " " << y << endl;
        }
        if(ch == 'L') {
